...
import com.pahanez.ppt.main.ui.gui.fragments.innerrecycler.InnerRecyclerFragment
...
object InnerRecyclerScreen: SupportAppScreen() {
    override fun getFragment(): Fragment {
        return InnerRecyclerFragment.newInstance()
    }
}